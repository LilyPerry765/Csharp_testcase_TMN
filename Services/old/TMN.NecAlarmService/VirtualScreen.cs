...
namespace Telnet
{
    ...
    public class VirtualScreen : IDisposable
    {
                ...
                switch (writeByte)
                {
                    ...
                    default:
                        ...
                        if (y >= 0)
                        {
                            try
                            {
                                this.vs[CursorX0, y] = writeByte == 0 ? (byte)(int)'*': writeByte;
                            }
                            catch
                            {
        ...
        {
            return this.FindRegExOnScreen(regExp, RegexOptions.None);
        ...
        /// <param name="caseSensitive">true for case sensitive search</param>
        /// <returns>string found</returns>
        public string FindRegExOnScreen(string regExp, RegexOptions options)
        {
