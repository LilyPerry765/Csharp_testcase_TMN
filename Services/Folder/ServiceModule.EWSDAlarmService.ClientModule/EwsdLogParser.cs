...
namespace TMN
{
    static class EwsdLogParser
    {

        public static LogAlarm ParseLog(string logBlock) //, IEnumerable<AlarmSeverityOverride> severityOverrides)
        {
            try
            {
        ...
        private static DateTime GetDateTime(string alarmBlock)
        {
            DateTime d;
        ...
        private static string GetTitle(string block)
        {
            try
            {
        ...
        private static int? GetMaskNumber(string block)
        {
        ...
        private static string GetLtg(string block)
        {
        ...
        private static AlarmSeverities DetermineSeverity(string alarmBlock)
        {
